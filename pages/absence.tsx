...
const AbsencePage: NextPage<IProps> = ({absences}) => {
    ...
    <Card style={{height:"38px",padding:"0px"}}><Card.Body style={{padding:"5px"}}>
    <Badge variant="success">Afwezig met reden</Badge>
    <Badge variant="warning" className="mx-1">Ziek</Badge>
    <Badge variant="danger">Ongeoorloofd afwezig</Badge>
        ...
        <tbody>
          {absences.map(a=><><tr className="bg-success text-light">
            <td>Naam1</td>
            <td>Datum1</td>
            <td>Les1</td>
            <td>Reden1</td>
          </tr><tr className="bg-success text-light">
            <td>Naam1</td>
            <td>Datum1</td>
            <td>Les1</td>
            <td>Reden1</td>
